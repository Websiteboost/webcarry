import { A as AstroError, w as MissingSharp } from './entrypoint_DdqMY4so.mjs';
import { b as baseService, p as parseQuality } from './generic_BTS2sr-N.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_Z4qZ1k80.mjs').then(n => n.i)).default;
  } catch {
